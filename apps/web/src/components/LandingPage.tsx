...
function Navbar({ onSignInClick }: { onSignInClick: () => void }): JSX.Element {
  ...
  return (
    <>
      ...
      >
        ...
        <a href="#" className="text-[32px] font-medium text-white underline underline-offset-2">
          Get in touch
        </a>
      </div>
    </>
...
function Hero({ onSignInClick }: { onSignInClick: () => void }): JSX.Element {
...
export function LandingPage({ onSignInClick }: Props): JSX.Element {
  return (
